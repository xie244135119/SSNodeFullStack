...
echo "  请重启进程使新库生效:"
echo "    pm2:     pm2 restart fullstack-template-backend"
echo "    systemd: systemctl restart fullstack-template-backend"
echo "    docker:  docker restart fullstack-template-backend"
